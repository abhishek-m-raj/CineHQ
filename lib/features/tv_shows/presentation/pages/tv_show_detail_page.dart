                        ...
                        builder: (context, favoriteIds) {
                          ...
                          return CircleAvatar(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                sl<TvFavoritesCubit>().toggleFavorite(
                                  tvShow.id,
                                );
                              },
                            ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (tvShow.numberOfEpisodes != null) ...[
                              Text(
                                '${tvShow.numberOfEpisodes} ${tvShow.numberOfEpisodes == 1 ? 'Episode' : 'Episodes'}',
                                style: theme.textTheme.bodyMedium?.copyWith(
                                  fontSize: 13,
                                ),
                              ),
                        ...
                        if (tvShow.genres.isNotEmpty) ...[
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: tvShow.genres.map((genre) {
                              return Container(
                                padding: const EdgeInsets.symmetric(
                                  horizontal: 12,
                                  vertical: 6,
                  ...
                  children: [
                    ...
                    CinePrimaryBtn(
                      ...
                      onTap: () {
                        ...
                        context.push(
                          '/play/tv/${tvShow.id}/$selectedSeason/$selectedEpisode?title=$title&firstAirDate=$firstAirDate',
                        );
                      },
                    ),
                  ],
