...
class CineLoadingIndicator extends StatelessWidget {
  final bool loading;

  const CineLoadingIndicator({super.key, this.loading = true});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final trailPaint = Paint()
      ..shader = SweepGradient(
        ...
        colors: [
          Colors.transparent,
          CineColorScheme.secondaryContainer.putOpacity(0.3),
          CineColorScheme.secondaryContainer,
          CineColorScheme.primary,
          Colors.white,
        ],
