...
class CineSecondaryBtn extends StatefulWidget {
  final String? text;
  ...
  @override
  State<CineSecondaryBtn> createState() => _HqSecondaryBtnState();
}

class _HqSecondaryBtnState extends State<CineSecondaryBtn> with SingleTickerProviderStateMixin {
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: _isActive ? CineColorScheme.surfaceBright.withValues(alpha: 0.9) : CineColorScheme.surfaceBright,
            ...
            boxShadow: _isActive
                ? [BoxShadow(color: CineColorScheme.surfaceBright.withValues(alpha: 0.3), blurRadius: 5, spreadRadius: 1)]
                : null,
          ),
          child: Material(
            ...
            child: InkWell(
              ...
              splashColor: CineColorScheme.onSurfaceBright.withValues(alpha: 0.2),
              highlightColor: CineColorScheme.onSurfaceBright.withValues(alpha: 0.1),
              onTap: widget.onTap,
              onFocusChange: (val) {
                    ...
                    children: [
                      if (widget.icon != null)
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            CineIcon(icon: widget.icon!, color: CineColorScheme.onSurfaceBright),
                            if (widget.text != null) SizedBox(width: CineSpacing.s1),
                          ],
                        ),
                      CineText(widget.text, style: CineTextStyles.btnText, color: CineColorScheme.onSurfaceBright),
                    ],
                  ),
                ),
              ),
